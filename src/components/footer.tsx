...
export function Footer() {
  return (
    <footer className="bg-[var(--beamira-dark)] text-white">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <p className="font-playfair text-xl font-medium mb-3">
              BEAMIRA FLOWERS
            </p>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="text-gray-400 hover:text-[var(--beamira-primary)] transition-colors"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>Tremblay-en-France (93), France</span>
              </li>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 flex justify-between items-center flex-wrap gap-4">
          ...
          <p className="text-gray-500 text-sm flex items-center gap-1">
            Fait avec amour <Heart size={16} className="text-[var(--beamira-primary)] inline" />
          </p>
        </div>
      </div>
    </footer>
